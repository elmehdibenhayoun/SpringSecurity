package ma.mundiapolis.hospitalapp;

import ma.mundiapolis.hospitalapp.entities.Patient;
import ma.mundiapolis.hospitalapp.repository.PatientRepository;
import ma.mundiapolis.hospitalapp.security.service.AccountService;
...
public class HospitalAppApplication {
    ...
    CommandLineRunner start(PatientRepository patientRepository){
        return args -> {
            ...
            patientRepository.save(new Patient(null,"omar",new Date(),true,98));
            patientRepository.save(new Patient(null,"ahmed",new Date(),true,342));
            patientRepository.save(new Patient(null,"Laila",new Date(),false,123));
            patientRepository.save(new Patient(null,"Mohamed",new Date(),false,42));
            patientRepository.save(new Patient(null,"yassine",new Date(),true,98));
            patientRepository.save(new Patient(null,"amine",new Date(),true,342));
            patientRepository.save(new Patient(null,"Laila",new Date(),false,123));
            patientRepository.save(new Patient(null,"Mohamed",new Date(),false,42));
